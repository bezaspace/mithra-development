...
class PatientProfile(BaseModel):
    ...
    allergies: list[str | AllergyRecord] = PydanticField(default_factory=list)
...
class PatientProfileRow(SQLModel, table=True):
    ...
    emergency_contact_json: str | None = Field(default=None)
    surgery_info_json: str | None = Field(default=None)
